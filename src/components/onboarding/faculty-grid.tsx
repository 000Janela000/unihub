        ...
        {faculties.map((faculty) => {
          ...
          return (
            <button
              ...
              className={cn(
                'relative flex items-center gap-2 rounded-lg border-2 px-2.5 py-2 transition-all duration-200 hover:-translate-y-0.5',
                isSelected
            ...
            >
              ...
              <span
                className={cn(
                  'text-[11px] font-semibold leading-tight text-left transition-colors duration-200',
